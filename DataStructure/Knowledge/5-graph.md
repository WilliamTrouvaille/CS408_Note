...
>
>    C++ 中一般使用各种数据类型的最大值表示无穷大,根据题意一般使用long类型的最大值.
>
...
+ 对于有向图
    + 第$i$个顶点的出度$=$第$i$行的非零元素个数
    + 第$i$个顶点的入度$=$第$i$列的非零元素个数
...
![1689599559t-20230717-2139-767.479](https://trouvaille-oss.oss-cn-beijing.aliyuncs.com/picList/1689599559t-20230717-2139-767.479.png)
...
>   $BFS$的时间复杂度分析如果利用最深层循环计算会有点问题还很复杂,直接简化问题为访问和查找两布即可
...
+ 广度优先生成树
    ...
    + 因为保存图的数据结构若是不唯一，则其广度优先生成树也是不唯一的
...
<img src="https://trouvaille-oss.oss-cn-beijing.aliyuncs.com/picList/1689603814t-20230717-2234-.-5.gif" style="zoom: 100%" />
...
public:
    ...
    void PrimMST() {
        ...
        std::vector<int> parent(numVertices, -1); // 记录生成树中每个顶点的父节点
...
public:
    ...
    void KruskalMST() {
        std::vector<int> parent(numVertices, -1); // 记录顶点的父节点
...
![sf4e534](https://trouvaille-oss.oss-cn-beijing.aliyuncs.com/picList/sf4e534.jpg)

| 中转点 |  -1  |      |      |  0   |      |      |  1   |      |      |  2   |      |      |
| :----: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| &emsp; |  v0  |  v1  |  v2  |  v0  |  v1  |  v2  |  v0  |  v1  |  v2  |  v0  |  v1  |  v2  |
