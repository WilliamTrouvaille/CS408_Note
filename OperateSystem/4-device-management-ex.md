...
+ 主要负责对硬件设备的具体控制,将上层发出的一系列命令（如$Read/Write$）转化成特定设备“能听得懂”的一系列操作
    + 包括设置设备寄存器、检查设备状态等。
...
![image-20230628165709930](C:/Users/willi/AppData/Roaming/Typora/typora-user-images/image-20230628165709930.png)
