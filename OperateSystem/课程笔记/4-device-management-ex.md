...
+ 本章很多知识点与硬件高度相关，建议与计算机组成原理的对应章节结合复习。
    + 己复习过计算机组成原理的读者遇到比较o熟悉的内容时也可适当跳过。
...
![45](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153754000.png)

### I/O设备基本概念

![image-20230628120818877](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153806773.png)
...
![image-20230628121557155](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153809710.png)
...
>
>   ![image-20230628122006104](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153812015.png)
...
![image-20230911120132155](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153814539.png)
...
![image-20230604153034078](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153816419.png)
...
![](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154533249.png)
...
+ $DMA$控制器结构：与$I/O$控制器结构类似：
    ...
    ![image-20230911121501924](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153819185.png)
...
![image-20230628125406287](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153822883.png)
...
>       + 未充分发挥$CPU$对主存的利用率。
>
>           ![image-20230604160332699](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153826201.png)
>
...
>
>           ![image-20230604160408365](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153840063.png)
...
![image-20230628125820100](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153849288.png)
...
![image-20230628145404314](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153855390.png)
...
![image-20230628151022837](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153858183.png)
...
![image-20230628163256519](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153912060.png)
...
![image-20230911223754831](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153916123.png)
...
+ 单缓冲区==处理一块数据平均耗时==$\max(C，T)+M$。
    ...
    + 若$T<C$，同理，整个过程用时$M+C$
        ...
        ![image-20230628161852906](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153918733.png)
...
+ 连续处理N块数据所用时间
    ...
    + 先读入磁盘块T1，然后送至用户区M1，M1执行完成以后，处理磁盘块C1和读入下一个磁盘块T2可以同时执行。
        ...
        ![img](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153921830.png)
...
+ 主要思想为
    ...
    + 则处理机又从缓冲区2中取出数据送入用户进程，而I/O设备又可以装填缓冲区1
        ...
        ![image-20230911223939994](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153924103.png)

+ 假设某用户进程请求某种块设备读入若干块的数据，若采用双缓冲的策略，操作系统会在主存中为其分配两个缓冲区（若题目中没有特别说明，一个缓冲区的大小就是一个块）。

+ 若两个相互通信的机器设置==双缓冲区==，则==同一时刻可以实现双向的数据传输==，否则==单缓冲区只能单向数据传输==。

![image-20230628162442437](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153926197.png)
...
![image-20230628162138741](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153928349.png)
...
+   连续处理N块数据所用时间
    ...
    + 假设我们有4个磁盘块需要处理，根据T和(M+C)的耗时不同可以分为如下两种情况：
        ...
        1.   T>C+ M时
             ...
             ![img](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153930392.png)
...
![image-20230628162544105](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153931742.png)
...
![image-20230911224748119](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153934023.png)
...
![image-20230628160145387](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153936903.png)
...
+ 设备控制表$DCT$：系统为每个设备配置一张$DCT$，用于记录设备情况：
    ...
    + 设备队列的队首指针：指向正在等待该设备的进程队列
        ...
        ![image-20230911225550473](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153939995.png)
...
+ 控制器控制表$COCT$：每个设备控制器都会对应一张**控制器控制表**$COCT$。因此每个**控制器控制表**$COCT$有一个表项存放指向相应**通道控制表**$CHCT$的指针，而一个通道可为多个设备控制器服务，因此**通道控制表**$CHCT$中必定有一个指针，指向一个表，这个表上的信息表达的是**通道控制表**$CHCT$提供服务的那几个设备控制器
    ...
    + 控制器队列的队尾指针：指向控制器的队尾。
        ...
        ![image-20230911225646716](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153942491.png)
...
+ 通道控制表$CHCT$：每个通道都会对应一张$CHCT$。操作系统根据$CHCT$的信息对通道进行操作和管理：
    ...
    + 通道队列的队尾指针：指向通道队列的队尾。
        ...
        ![image-20230911230058855](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153944808.png)
...
+ 系统设备表$SDT$，==整个系统只有一张==，记录了系统中全部设备的情况，每个设备对应一个表目：
    ...
    + 驱动程序入口：对应设备驱动的程序地址。
        ...
        ![image-20230911230106549](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153947466.png)
...
![image-20230628154521217](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153949465.png)

#### 脱机技术

![image-20230628153837292](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153951608.png)
...
+ $SPOOLing$系统组成：
    ...
    + 输入缓冲区与输出缓冲区
        ...
        ![image-20230911230939421](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153953724.png)
...
>   此系统的示意图如下图所示
>
>   ![image-20230912111016960](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023153955955.png)
>
...
![76e](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154001278.png)

### 磁盘概念

#### 磁盘结构

![image-20230628163712978](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154005491.png)
...
![image-20230912192514159](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154007815.png)
...
3. 引导块
    ...
    + 下面以Windows为例来分析引导过程。 
        ...
        ![image-20230912194730584](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154010820.png)
...
+ **寻找时间/寻道时间**$T_s$：在读/写数据前，将磁头移动到指定磁道所花的时间：
    ...
    + 移动磁头也是需要时间的，假设磁头匀速移动，每跨越一个磁道耗时为$m$，总共需要跨越$n$条磁道
        ...
        ![GeePlayer_eQgKqNPcgU](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154013457.gif)
...
+ 旋转延迟时间$T_r$：通过旋转磁盘，使磁头定位到目标扇区所需要的时间。
    ...
    + 找到目标扇区平均需要转半圈，因此再乘$\dfrac{1}{2}$。
        ...
        ![GeePlayer_HvQWv7KIUe](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154016144.gif)
...
+ 传输时间$T_t$：从磁盘读出或向磁盘写入数据所经历的时间，这个时间取决于每次所读/写的字节数b和磁盘的旋转速度r
    ...
    + 而读/写一个磁道所需的时间刚好又是转一圈所需要的时间$\dfrac{1}{r}$，$T_t=\dfrac{1}{r}\times\dfrac{b}{N}$。
        ...
        ![GeePlayer_nTbaNPtbgd](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154019199.gif)
...
![image-20230912200537920](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154022935.png)
...
![image-20230628164509662](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154025437.png)
...
![image-20230628164658753](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154027409.png)
...
![image-20230628164755839](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154029385.png)
...
![image-20230628164940689](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154032098.png)
...
![image-20230628165101149](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154034301.png)
...
![image-20230628165233313](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154036884.png)
...
![image-20230601143941680](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154039439.png)

![image-20230601144217002](https://raw.githubusercontent.com/WilliamTrouvaille/image_hosting/main/CS408_NOTE/20251023154042133.png)
