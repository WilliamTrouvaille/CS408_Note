...
![image-20230722200912997](https://trouvaille-oss.oss-cn-beijing.aliyuncs.com/picList/202307222032728.webp)
...
![23July22-201817-1690028297-b0414710-1a8d-4f42-b0d3-93f8deb562ab](https://trouvaille-oss.oss-cn-beijing.aliyuncs.com/picList/202307222018112.png)
...
void insertion_sort(int arr[], int len) {
    ...
    for (int i = 1; i != len; ++i) {
        ...
        int key = arr[i];
        // 存储当前待插入的元素值，这个元素将被依次插入到前面已排序的子数组中
...
+   算法思路
    ...
    +   每次对比只对比两个以上的个元素进行插入交换。
        ...
        ![23July22-203525-1690029325-74ec87de-c88e-4832-9ae7-442912455c87](https://trouvaille-oss.oss-cn-beijing.aliyuncs.com/picList/202307222035265.png)
...
![23July23-194928-1690112968-76b71674-e481-45c8-b6cd-4e1d0e78794a](https://trouvaille-oss.oss-cn-beijing.aliyuncs.com/picList/202307231949761.png)
